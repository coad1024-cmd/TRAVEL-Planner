// ============================================================
// Core domain types for the Travel & Hospitality System
// ============================================================
...
export interface TravelerProfile {
  ...
  budget_comfort_zone: { min: Money; max: Money };
  companions: { name: string; relationship: string; preferences?: Record<string, unknown> }[];
  documents: {
...
export interface TravelAdvisory {
  country_code: string;
  level: 1 | 2 | 3 | 4; // 1=normal, 4=do not travel
  summary: string;
  last_updated: string;
  source_url: string;
}
